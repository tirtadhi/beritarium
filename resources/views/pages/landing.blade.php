...
@section('title', 'Beritarium | Portal Baca Berita')
      ...
      <div class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-12 gap-5">
        ...
        <div
          ...
          <a href="{{ route('news.show', $news[0]->slug) }}">
            <div class="bg-primary text-white rounded-full w-fit px-4 py-1 font-normal ml-5 mt-5 absolute">{{ $news[0]->newsCategory->title }}</div>
            ...
            <p class="text-slate-400 text-base mt-1"></p>
          </a>
        </div>
        ...
        <a href="{{ route('news.show', $new->slug) }}"
          ...
          <div class="bg-primary text-white rounded-full w-fit px-4 py-1 font-normal ml-2 mt-2 absolute text-sm">{{ $new->newsCategory->title }}</div>
          <img src="{{ asset('storage/' . $new->thumbnail) }}" alt="berita" class="rounded-xl md:max-h-48" style="width: 250px; object-fit:cover;">
      ...
      <div class="grid sm:grid-cols-1 gap-5 lg:grid-cols-4">
        ...
        <a href="{{ route('news.show', $choice->slug) }}">
          <div
            ...
            <img src="{{ asset('storage/' . $choice->thumbnail) }}" alt="" class="w-full rounded-xl mb-3" style="width: 400px; object-fit:cover;">
